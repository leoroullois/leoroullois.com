...
const recommandation = () => {
  return (
    <section className='pt-16  overflow-hidden'>
      <Wrapper className={clsx('flex-col gap-12 justify-between items-center pb-5 border-b border-b-slate-900/10', "sm:flex-row")}>
        ...
        <div className='relative flex flex-col justify-evenly gap-y-5'>
          ...
          <p className='relative z-20 text-md font-bold text-pink-500'>Sylvain Gibaud</p>
        </div>
      </Wrapper>
    </section>
  );
